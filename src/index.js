...
module.exports={
  ...
  "scripts": {
    ...
    "dev": "mocha test --recursive --watch",
    "dev-build": "browserify src/core.js -t babelify --outfile src/index.js"
  },
...
var character = new _vue2.default({
    ...
    methods: {
        assembleCharacters: function assembleCharacters() {
            console.log('Assembling Characters');
            var vm = this.$data;

            this.$http.get('http://www.bungie.net/Platform/Destiny/' + vm.membershipType + '/Stats/GetMembershipIdByDisplayName/' + vm.displayName + '/').then(function (response) {

                vm.membershipId = response.body.Response;
            }, function (err) {
                vm.message = 'Failed to fetch your MembershipID: ' + err;
            }).then(function () {
                this.$http.get('http://www.bungie.net/Platform/Destiny/' + vm.membershipType + '/Account/' + vm.membershipId + '/Summary/').then(function (response) {
                    ...
                    var chars = vm.characterData.characters;
        ...
        isActive: function isActive(characters) {
...
},{"vue":3,"vue-resource":2}],6:[function(require,module,exports){
'use strict';
...
},{"../../package.json":4,"vue":3}],7:[function(require,module,exports){
'use strict';

require('./components/header.js');
require('./components/character.js');

},{"./components/character.js":5,"./components/header.js":6}]},{},[7]);
