...
},{"babel-register":3}],2:[function(require,module,exports){
(function (global){
"use strict";
...
},{"core-js/fn/regexp/escape":5,"core-js/shim":298,"regenerator-runtime/runtime":300}],3:[function(require,module,exports){
"use strict";
...
},{"_process":299}],303:[function(require,module,exports){
module.exports={
  "name": "lorebotext",
  "version": "0.0.3",
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return vm.$http.get('http://www.bungie.net/Platform/Destiny/' + vm.membershipType + '/Stats/GetMembershipIdByDisplayName/' + vm.displayName + '/');
          ...
          case 8:
            _context.next = 10;
            return vm.$http.get('http://www.bungie.net/Platform/Destiny/' + vm.membershipType + '/Account/' + vm.membershipId + '/Summary/');
          ...
          case 10:
            ...
            chars = vm.characterData.characters;
          ...
          case 19:
            ...
            vm.message = 'Failed to assemble characters: ' + _context.t0.statusText;
...
},{"co":4,"vue":302,"vue-resource":301}],305:[function(require,module,exports){
'use strict';
...
},{"../../package.json":303,"vue":302}],306:[function(require,module,exports){
'use strict';
...
},{"./components/character.js":304,"./components/header.js":305,"babel-core/register":1,"babel-polyfill":2}]},{},[306]);
